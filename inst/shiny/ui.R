  ...
  navbarPage(theme=shinythemes::shinytheme('united'), id='tabs', collapsible=TRUE,
             ...
             fluidRow(column(4,
                             wellPanel(
                               ...
                               # POST PROCESING DATA (**) ####
                               conditionalPanel("input.tabs == 'ppdat'",
                                                h4("Post-processing data (**)"),
                                                radioButtons("ppdatSel", "Modules Available:",
                                                             choices = list("User SDM (**)" = 'userSDM',
                                                                            "Post-proc rasters (**)" = 'ppRasters'),
                                                             selected = 'userSDM'),
                                                HTML('<hr>'),
                                                conditionalPanel("input.ppdatSel == 'userSDM'",
                                                                 uiTop(userSDM_INFO),
                                                                 userSDM_UI('ppdat_userSDM_uiID'),
                                                                 actionButton("goUserSDM", "Load SDM(**)"),
                                                                 HTML('<hr>')),
                                                conditionalPanel("input.ppdatSel == 'ppRasters'",
                                                                 uiTop(ppRasters_INFO),
                                                                 ppRasters_UI('ppdat_ppRasters_uiID'),
                                                                 actionButton("goPpRasters", "Load Rasters(**)"),
                                                                 HTML('<hr>')),
                                                conditionalPanel("input.ppdatSel == 'userSDM'", uiBottom(userSDM_INFO)),
                                                conditionalPanel("input.ppdatSel == 'ppRasters'", uiBottom(ppRasters_INFO))
                               ),
                               # POST PROCESING MASKRANGER ####
                               conditionalPanel("input.tabs == 'mask'",
                                                h4("Post-processing(**)"),
                                                radioButtons("maskSel", "Modules Available:",
                                                             choices = list("Olinguito(**)" = 'olinMask', 
                                                                            "Biomodelos(**)" = 'biomMask'), 
                                                             selected = 'olinMask'),
                                                HTML('<hr>'),
                                                conditionalPanel("input.maskSel == 'olinMask'",
                                                                 uiTop(olinguito_INFO),
                                                                 olinguito_UI('mask_olinguito_uiID'),
                                                                 actionButton("goOlinguito", "Run (**)"),
                                                                 HTML('<hr>')),
                                                conditionalPanel("input.maskSel == 'biomMask'",
                                                                 uiTop(biomodelos_INFO),
                                                                 biomodelos_UI('mask_biomodelos_uiID'),
                                                                 actionButton("goBiomodelos", "Action (**)"),
                                                                 HTML('<hr>')),
                                                conditionalPanel("input.maskSel == 'olinMask'", uiBottom(olinguito_INFO)),
                                                conditionalPanel("input.maskSel == 'biomMask'", uiBottom(biomodelos_INFO))
                               ),
                               # SESSION CODE ####
