#
# userBiasBg_UI <- function(id) {
#   ns <- NS(id)
#   tagList(
#     fileInput(ns("userCSV"), label = "Upload Custom Background CSV")
#   )
# }
#
# userBiasBg_MOD <- function(input, output, session) {
#   reactive({
#     # FUNCTION CALL ####
#     occsList <- samp_userBiasBg(input$userCSV$datapath, input$userCSV$name, shinyLogs)
#
